				...
				if fib_data[0] == 'BULL':
					...
					if len(bull_willy) > 0:
						...
						if len(bull_divergences) > 0:
							...
							email_info.write("nr of willy values:" + str(len(bull_willy)) + '\n')
							# for w in bull_willy:
								# print(w)
							print("nr of divergences:", len(bull_divergences))
							email_info.write("nr of divergences:" + str(len(bull_divergences)) + '\n')
				...
				if fib_data[0] == 'BEAR':
					...
					if len(bear_willy) > 0:
						...
						if len(bear_divergences) > 0:
							...
							email_info.write("nr of willy values:" + str(len(bear_willy)) + '\n')
							# for w in bear_willy:
								# print(w)
							print("nr of divergences:", len(bear_divergences))
							email_info.write("nr of divergences:" + str(len(bear_divergences)) + '\n')
